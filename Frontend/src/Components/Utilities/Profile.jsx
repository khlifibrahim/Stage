...
function Profile() {
  ...
  return (
    <div onClick={handleProfileMenu} className='relative flex items-center justify-center gap-3 cursor-pointer'>
      ...
      {/* Profile Name and Role (only on desktop) */}
      ...
      {/* Arrow icon (rotates when menu is active) */}
      <div className="rotate-90 ${isProfileMenuActive ? '' : 'rotate-0'}">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='hover:stroke-blue icon icon-tabler icons-tabler-outline icon-tabler-chevron-right'>
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M9 6l6 6l-6 6" />
        </svg>
      </div>

      {/* Profile menu (only shown when profile icon is clicked) */}
      {isProfileMenuActive && (
        <div className='absolute top-16 right-0 bg-white p-4 rounded-md shadow flex flex-col gap-2'>
          <Link to="/dashboard/profile">
            <div className='flex items-center justify-start gap-2 px-2 h-11 rounded-[10px] transition-colors hover:bg-bg-blue hover:text-blue cursor-pointer'>
              <span className="icon hover:svg>stroke-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:stroke-blue icon icon-tabler icons-tabler-outline icon-tabler-user-star">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <div onClick={handleLogout} className='flex items-center justify-start gap-2 px-2 h-11 rounded-[10px] transition-colors hover:bg-bg-blue hover:text-blue cursor-pointer'>
            <span className="icon hover:svg>stroke-blue">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:stroke-blue  icon icon-tabler icons-tabler-outline icon-tabler-logout">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
