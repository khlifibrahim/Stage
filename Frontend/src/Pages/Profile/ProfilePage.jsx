  ...
  return (
    <div>
      <div className="header">
        ...
        <div className='profile flex flex-col md:flex-row items-center justify-between my-8'>
          <div className='flex flex-col md:flex-row items-center gap-6'>
            <div className="avatar bg-blue w-32 h-32 rounded-full flex items-center justify-center">
              <h1 className='font-bold text-[40px] md:text-[52px] text-white'>{user.nom.charAt(0).toUpperCase() || 'A'}</h1>
            </div>
            <div>
              <div className="name text-[20px] md:text-[24px] font-bold">{user.nom || "Alex Rawlers"} {user.prenom}</div>
          ...
          <div className='edit mt-4 md:mt-0'>
            <button
                type="submit"
